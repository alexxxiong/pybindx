...
class CppClassesWrapperWriter(base_writer.CppBaseWrapperWriter):
    """
    ...
    def __init__(self, class_info, wrapper_templates):
        ...
        super(CppClassesWrapperWriter, self).__init__(wrapper_templates)
    ...
    def write_files(self, work_dir, class_short_name):
        ...
        """
        path = work_dir + "/" + "Parser"
        hpp_file = open(path + ".pybindx.hpp", "a")
        hpp_file.write(self.hpp_string)
        hpp_file.close()

        cpp_file = open(path + ".pybindx.cpp", "a")
    ...
    def add_hpp(self, class_short_name):
        ...
        self.hpp_string += self.wrapper_templates['classes_hpp_context'].format(**wrapper_dict)
    ...
    def add_cpp_header(self, class_full_name, class_short_name):
        ...
        header_string = self.wrapper_templates["classes_cpp_context"].format(**header_dict)
